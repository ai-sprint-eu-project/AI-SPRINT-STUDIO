...
from aisprint.annotations import component_name, model_performance, exec_time
from aisprint.onnx_inference import load_and_inference


@component_name(name='classifier')
@exec_time(local_time_thr=10)
@model_performance(metric='average_f1', # accuracy, precision, recall, f1 
                   metric_thr=0.5)
def main(args):
...
if __name__ == '__main__':
    ...
    parser.add_argument("-y", "--onnx_file", default="onnx/classifier.onnx", help="complete path to the ONNX model")
