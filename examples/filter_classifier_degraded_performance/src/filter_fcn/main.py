...
@annotation({'component_name': {'name': 'filter_fcn'}, 
             'exec_time': {'local_time_thr': 20}, 
             'model_performance': {'filtered_class': 'object'},
...
if __name__ == '__main__':
    ...
    parser.add_argument("-y", "--onnx_file", default="onnx/filter_fcn.onnx", help="complete path to tge ONNX model")
