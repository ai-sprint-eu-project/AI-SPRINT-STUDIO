...
@component_name(name='third_component')
@exec_time(global_time_thr=30, prev_components=['mask-detector-onnx'])
def main(args):
	...
	input_dict['COLORS'] = args['COLORS']
	input_dict['LABELS'] = args['LABELS']
...
if __name__ == '__main__':
	...
	parser.add_argument("-y", "--onnx_file", default="onnx/yolov3-tiny.onnx", help="complete path to mask detector ONNX model")
	parser.add_argument("-cfg", "--cfg_path", default="cfg", help="base path to the obj.names specifying classes names")
